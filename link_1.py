...
import queue
import threading
from network_1 import NetworkPacket
...
class Link:
    ...
    def tx_pkt(self):
        ...
        if len(pkt_S) > self.out_intf.mtu:
            ...
            # TODO write segmentPacket method, can we import network? where should we segment packets?
            ...
            for x in range(0, len(packetsSegmented)):
                ...
                self.out_intf.put(packetsSegmented[x])
